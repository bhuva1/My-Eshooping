       ...
       <div class ="form-horizontal">
               ...
               <div class ="col-md-3">
                <asp:TextBox ID="txtProductName" CssClass ="form-control" runat="server"></asp:TextBox>
                   <asp:RequiredFieldValidator ID="RequiredFieldValidatorProductname" runat="server" 
                       ControlToValidate="txtProductName"  CssClass ="text-danger " ErrorMessage="Enter Product Name" ForeColor="Red"></asp:RequiredFieldValidator>
           ...
           <div class ="form-group">
               ...
               <asp:TextBox ID="txtPrice" CssClass ="form-control" runat="server"></asp:TextBox>
                   <asp:RequiredFieldValidator ID="RequiredFieldValidatorPrice" runat="server" 
                       ControlToValidate="txtPrice"  CssClass ="text-danger " ErrorMessage="Enter Price" ForeColor="Red"></asp:RequiredFieldValidator>
           ...
           <div class ="form-group">
               ...
               <asp:TextBox ID="txtsellPrice" CssClass ="form-control" runat="server"></asp:TextBox>
                   <asp:RequiredFieldValidator ID="RequiredFieldValidatorsellprice" runat="server" 
                       ControlToValidate="txtsellPrice"  CssClass ="text-danger " ErrorMessage="Enter your sellprice"></asp:RequiredFieldValidator>
